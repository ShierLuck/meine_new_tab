      ...
      , c = function() {
                ...
                if (localStorage.getItem("countdown_notified") === "no") {
                    ...
                    swal({
                        ...
                        if (g == 10 && m == 31 || g == 12 && m == 24 || g == 12 && m == 25 || g == 12 && m == 31 || g == 1 && m == 1) {
                            ...
                            if (s > new Date(h))
                                h = `${d + 1}-${("0" + g).slice(-2)}-${("0" + m).slice(-2)}T${("0" + f).slice(-2)}:${("0" + w).slice(-2)}`;
                        ...
                        if (localStorage.getItem("snow_type") !== "fireworks")
                            e.stopFireworksCanvas();
        ...
        function h() {
            ...
            if (localStorage.getItem("enable_countdown") == "yes")
                e.countDownThread = setTimeout(h, 999)
        }
