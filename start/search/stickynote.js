...
window.storedNotes = [];
// window.noteColors = {
//   blue: { title: "#c9ecf8", body: "#c0e1f5" },
//   green: { title: "#c8f8c3", body: "#A3ED9B" },
//   pink: { title: "#f1c3f1", body: "#ecb2ec" },
//   purple: { title: "#d6cffe", body: "#cbc0fe" },
//   yellow: { title: "#fdfcbf", body: "#fcfaae" },
...
var StickyNote = function (e, t) {
  ...
  s.addEventListener("click", function (e) {
    ...
    if (n + helpers.pxTOvw(d.offsetWidth) > helpers.pxTOvw(window.innerWidth)) {
      n = helpers.pxTOvw(
        window.lastNote.offsetLeft +
          window.lastNote.offsetWidth +
          30 -
          window.innerWidth
      );
    }
    var i = new StickyNote({ top: t, left: n }, true);
    ...
    window.addEventListener(
      ...
      function (e) {
        ...
        if (t === 27) {
          e.preventDefault();
          o.contextMenus &&
            o.contextMenus.parentNode.removeChild(o.contextMenus);
          o.contextMenus = null;
        }
      },
      false
...
function syncNote(e, t, n) {
  chrome.runtime.sendMessage(
    { noteChange: { type: e, data: t, options: n } },
    function (e) {}
  );
  localStorage.setItem("notes", JSON.stringify(window.storedNotes));
}
...
function createMenuButton() {
  ...
  stnButton.innerHTML =
    window.storedNotes.length > 0 ? "&#128465; Clear Notes" : "+ New note";
...
function onLoad() {
  ...
  enable_stickynote_cbk.addEventListener("change", function (e) {
    ...
    syncNote(2, { enabled: e.target.checked });
