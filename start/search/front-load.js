...
(function (e) {
  ...
  e.animations = [
    ...
    { value: "bounceInDown", text: "Bounce-In-Down" },
    { value: "bounceInLeft", text: "Bounce-In-Left" },
    { value: "bounceInRight", text: "Bounce-In-Right" },
    { value: "bounceInUp", text: "Bounce-In-Up" },
    { value: "fadeInDown", text: "Fade-In-Down" },
    { value: "fadeInLeft", text: "Fade-In-Left" },
    { value: "fadeInRight", text: "Fade-In-Right" },
    { value: "fadeInUp", text: "Fade-In-Up" },
    { value: "lightSpeedIn", text: "Flip-Speed-In" },
    { value: "rotateInDownLeft", text: "Rotate-In-Down-Left" },
    { value: "rotateInDownRight", text: "Rotate-In-Down-Right" },
    { value: "rotateInUpLeft", text: "Rotate-In-Up-Left" },
    { value: "rotateInUpRight", text: "Rotate-In-Up-Right" },
    { value: "rollIn", text: "Roll-In" },
    { value: "zoomIn", text: "Zoom-In" },
    { value: "slideInDown", text: "Slide-In-Down" },
    { value: "slideInLeft", text: "Slide-In-Left" },
    { value: "slideInRight", text: "Slide-In-Right" },
    { value: "slideInUp", text: "Slide-In-Up" }
  ];
  ...
  e.setBackgroundGIFOrJPG = function (e) {
    ...
    // var f = Object.keys(user["bg_color_gif"]).indexOf(
    //   e.replace(/\.jpg$/, ".gif")
    // );
    ...
    if (f > -1) {
      ...
      o.style.backgroundImage =
        "url(" +
        chrome.extension.getURL("/start/skin/images/" + chosenRandomBG) +
        ")";
      ...
      if(true){
        ...
        if (
          ...
          if (!document.getElementById("frame_bg")) {
            ...
            u.style =
              'background-image: url("/start/skin/images/' +
              d +
              '"); width: 100%; height: 100%; background-repeat: no-repeat; background-size: 900px; background-position: center center;';
  ...
  e.setNewTabBackground = function () {
    ...
    if (
      localStorage.getItem("shuffle_background") == "yes" ||
      (localStorage.getItem("shuffle_favorites") == "yes" && n.length == 0)
    ) {
      var g;
      if (o == "0") {
        g = 1;
    ...
    var imageExt = ".jpg";
    imageName = "bg-" + (Number(g) < 100 ? ("0" + g).slice(-2) : g);
    chosenRandomBG = imageName + imageExt;
    if(chosenRandomBG === "bg-68.jpg"){
    	chosenRandomBG = "bg-68.gif";
    }
    e.setBackgroundGIFOrJPG(chosenRandomBG);
  };
  
  if (
    localStorage.getItem("c_bg_b_d") === "no" ||
    !localStorage.getItem("c_bg_b_d")
  ) {
    ...
    if (n) {
      chosenRandomBG =
        "bg-" + (Number(n) < 100 ? ("0" + n).slice(-2) : n) + ".jpg";
    } else {
